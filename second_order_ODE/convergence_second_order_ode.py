...
if __name__ == '__main__':
    ...
    primal_tau, _, _ = compute_convergence_primal(mu=mu,
                                                  ...
                                                  P=P)
    if not psd:
        print('Convergence guarantee for fixed P (relaxed)', tau_verif, 4 / 3 * np.sqrt(mu))
        print('Primal : convergence guarantee for fixed P (relaxed)', -primal_tau, 4 / 3 * np.sqrt(mu))
    else:
